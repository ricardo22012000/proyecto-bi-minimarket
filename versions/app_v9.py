"""
============================================================
DASHBOARD BI - MINIMARKET - VERSIÓN 9
============================================================
Autor: Ricardo Muñoz
Empresa: G&S Gestión y Sistemas
Fecha: Julio 2026
============================================================
MEJORAS RESPECTO A V8:
  ✅ Colores vibrantes en Ventas por Día (ya no se pierde en gris)
  ✅ Esquema por tipo de día (laborables vs fin de semana)
...
# ============================================================
st.set_page_config(
    page_title="Dashboard BI v9 - Minimarket | G&S",
    page_icon="🛒",
    layout="wide",
...
st.sidebar.caption("G&S • v9 colores vibrantes")
...
# ============================================================
    ...
    # ============================================================
    # 📅 VENTAS POR DÍA (%) ⭐ COLORES VIBRANTES POR TIPO DE DÍA
    # ============================================================
    with col2:
        ...
        # 🎨 Colores vibrantes por tipo de día
        colores_dia = {
            "Lunes": "#1f4e79",      # Azul corporativo
            "Martes": "#1f4e79",     # Azul corporativo
            "Miércoles": "#1f4e79",  # Azul corporativo
            "Jueves": "#1f4e79",     # Azul corporativo
            "Viernes": "#FF7F50",    # Naranja (inicio finde)
            "Sábado": "#E74C3C",     # Rojo coral (día pico)
            "Domingo": "#9B59B6"     # Púrpura (cierre semana)
        }
