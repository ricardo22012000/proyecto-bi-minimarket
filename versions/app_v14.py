...
# ============================================================
st.set_page_config(
    page_title="Dashboard BI v14 - Minimarket | G&S",
    page_icon="🛒",
    layout="wide",
...
# ============================================================
# SIDEBAR (HEADER LIMPIO Y AGRANDADO)
# ============================================================
st.sidebar.markdown(
    '<p class="sidebar-title"><span class="sidebar-icon">🛒</span> Dashboard BI</p>',
    unsafe_allow_html=True
)
