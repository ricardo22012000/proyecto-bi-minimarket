"""
============================================================
DASHBOARD BI - MINIMARKET - VERSIÓN 8
============================================================
Autor: Ricardo Muñoz
...
MEJORAS RESPECTO A V7:
  ✅ Ventas por Turno en porcentaje (%)
  ✅ Ventas por Día en porcentaje (%)
  ✅ Ejes Y de los gráficos ajustados a formato %
  ✅ Hover con valor absoluto + porcentaje
============================================================
"""
...
# ============================================================
st.set_page_config(
    page_title="Dashboard BI v8 - Minimarket | G&S",
    page_icon="🛒",
    layout="wide",
...
st.sidebar.caption("G&S • v8 porcentajes")
...
# ============================================================
    ...
    # ============================================================
    # 🕐 VENTAS POR TURNO (EN PORCENTAJE) ⭐ NUEVO
    # ============================================================
    with col1:
    ...
    # ============================================================
    # 📅 VENTAS POR DÍA (EN PORCENTAJE) ⭐ NUEVO
    # ============================================================
    with col2:
