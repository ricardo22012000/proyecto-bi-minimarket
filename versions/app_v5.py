"""
============================================================
DASHBOARD BI - MINIMARKET - VERSIÓN 5
============================================================
Autor: Ricardo Muñoz
...
MEJORAS RESPECTO A V4:
  ✅ Panel de administración para subir nuevo Excel
  ✅ Validación automática de estructura del archivo
  ✅ ETL integrado en el dashboard (sin ejecutar script)
  ✅ Recarga automática de datos tras actualización
  ✅ Indicador de última actualización en header
============================================================
"""
...
# ============================================================
st.set_page_config(
    page_title="Dashboard BI v5 - Minimarket | G&S",
    page_icon="🛒",
    layout="wide",
...
# ============================================================
# FUNCIONES ETL (integradas en el dashboard)
# ============================================================
...
st.sidebar.caption("G&S • v5 con upload")
...
with st.sidebar.expander("⚙️ Administración - Subir Excel"):
    ...
    if archivo_subido is not None:
        ...
        if not valido:
            ...
            # Vista previa
            try:
                df_preview = pd.read_excel(archivo_subido, sheet_name="Historial_Ventas", nrows=3)
            ...
            if st.button("🚀 Procesar y actualizar dashboard", type="primary", use_container_width=True):
                with st.spinner("⚙️ Procesando ETL... esto puede tardar unos segundos"):
                    try:
                        # Guardar el archivo subido en /data/
...
# ============================================================
    ...
    with col1:
        ...
        fig_heat1 = px.imshow(pivot_cat_suc, text_auto=".2s", aspect="auto", color_continuous_scale="Blues")
...
# ============================================================
    ...
    fig_heat2 = px.imshow(pivot_dia_turno, text_auto=".2s", aspect="auto", color_continuous_scale="Reds")
    fig_heat2.update_layout(height=200, margin=dict(l=10, r=10, t=10, b=10), xaxis_title="", yaxis_title="", coloraxis_showscale=False)
