"""
============================================================
DASHBOARD BI - MINIMARKET - VERSIÓN 7
============================================================
Autor: Ricardo Muñoz
...
MEJORAS RESPECTO A V6:
  ✅ Granularidad dinámica en el gráfico de evolución
     - Rango ≤ 60 días → agrupa por día
     - Rango 61-180 días → agrupa por semana
     - Rango > 180 días → agrupa por mes
  ✅ El gráfico se dibuja correctamente en cualquier rango
  ✅ Mensaje amigable cuando hay un solo punto de datos
============================================================
"""
...
# ============================================================
st.set_page_config(
    page_title="Dashboard BI v7 - Minimarket | G&S",
    page_icon="🛒",
    layout="wide",
...
st.sidebar.caption("G&S • v7 granularidad dinámica")
...
if pagina == "📊 General":
    ...
    # === GRÁFICO CON GRANULARIDAD DINÁMICA ===
    ...
    # Manejar caso de un solo punto (mostrar barras en lugar de área)
    if len(ventas_periodo) < 2:
        ...
        # Ajustar smoothing según número de puntos (más puntos = menos smoothing)
